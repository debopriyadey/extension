...
export default function GetSeedPhase() {
    return (
        <div>
        ...
        <div className="card">
            <div className="card-body">
                ...
                <h3 className="card-title mt-3 mb-2 text-center">Import Existing Wallet</h3>
                <hr height="5px" size="5px" style={{color: 'blueviolet'}} />
                <div className="row my-4">
                    <div className="col-12">
                        <div className="form-group">
                            <label>Private Key</label>
                            <input className="form-control" type="text" placeholder="private key" />
                        </div>
                    </div>
                </div>
                <div className="row my-4 ">
                    ...
                    <div className="mt-3" style="background-color: rgb(32, 31, 31);">
                ...
                <div className="row button">
                    <div className="col-12 text-center">
                        <button className="btn btn-primary btn-block confirm-button"><a href="./main">Import</a> </button>
                    </div>
                </div>
            </div>
        </div>
